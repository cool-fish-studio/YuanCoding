...
var codeApi = require('../api/v1/code/controller');

//根据ID查询某一个
module.exports.getByID = function (codeID, callback) {
    codeApi.getByID(codeID, callback);
};

//创建
module.exports.insert = function (fields, callback) {
    codeApi.insert(fields, callback);
};

//修改
module.exports.update = function (code, fields, callback) {
    codeApi.update(code, fields, callback);
};
